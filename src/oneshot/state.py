"""OneshotState TypedDict — the single state object flowing through the pipeline."""
...
from oneshot.schemas.spec import IdeaSpec
from oneshot.schemas.prd import PRD
from oneshot.schemas.sdd import SDD
from oneshot.schemas.hld import HLD, ComponentDesign
from oneshot.schemas.component import ComponentResult
from oneshot.schemas.quality import GateResult
from oneshot.schemas.release import ReleaseInfo


class OneshotState(TypedDict, total=False):
    # Input
    raw_idea: str
