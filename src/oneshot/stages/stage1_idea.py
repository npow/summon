...
from oneshot.agents.ambiguity import create_ambiguity_node
from oneshot.agents.spec_writer import create_clarify_node, create_spec_writer_node
from oneshot.agents.base import create_agent_node
from oneshot.config import OneshotConfig
from oneshot.prompts.stage1 import SPEC_VALIDATOR
...
def create_stage1_graph(config: OneshotConfig) -> StateGraph:
