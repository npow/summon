...
from oneshot.agents.packager import create_packager_node
from oneshot.agents.docs_writer import create_docs_writer_node
from oneshot.agents.github_agent import create_github_agent_node
from oneshot.agents.publisher import create_publisher_node
...
def create_stage6_graph(config: OneshotConfig) -> StateGraph:
