...
from oneshot.agents.prd import create_prd_node
from oneshot.agents.sdd import create_sdd_node
from oneshot.agents.critic import create_critic_node
...
def create_stage2_graph(config: OneshotConfig) -> StateGraph:
