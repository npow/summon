...
from forge.supervisor import create_gate_node, gate_passed
from forge.stages.stage1_idea import create_stage1_graph
from forge.stages.stage2_planning import create_stage2_graph
from forge.stages.stage3_design import create_stage3_graph
from forge.stages.stage4_implement import create_stage4_graph
from forge.stages.stage5_testing import create_stage5_graph
from forge.stages.stage6_release import create_stage6_graph
...
def build_pipeline(
    ...
    """Build the Forge pipeline graph.

    Args:
        config: Forge configuration (uses defaults if None)
