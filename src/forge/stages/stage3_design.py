...
from forge.agents.architect import create_architect_node
from forge.agents.splitter import create_splitter_node
...
def create_stage3_graph(config: ForgeConfig) -> StateGraph:
